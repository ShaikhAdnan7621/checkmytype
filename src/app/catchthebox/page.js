...
export default function App() {
    ...
    return (
        <div className="h-screen relative flex items-center justify-center bg-gray-900">
            <div className="w-screen h-full flex flex-col items-center justify-center text-yellow-400">
                <div
                    className="w-72 sm:w-[640px] relative h-full bg-gradient-to-b from-yellow-800 to-orange-950 mx-auto rounded-lg flex transform rotate -mt-20"
                    style={{
                        transform:
                ...
                >
                    ...
                    >
                        {boxes.left.map((box, i) => (
                            <div
                                key={i}
                                className="absolute left-1/2 -translate-x-1/2 w-4/5 bg-gradient-to-b from-yellow-400 to-orange-500 mx-auto rounded-xl"
                                style={{
                                    height: box.height,
                                    top: box.top,
                ...
                {/* Score and Lifeline */}
                <div className="absolute bottom-0 left-0 right-0 h-14 bg-orange-500 flex items-center justify-center text-white font-bold py-1.5 px-2">
                    Press {`"F"`} for left, {`"J"`} for right, and {`"Space"`}
                    for center.
                </div>
                <div className="absolute top-0 left-0 right-0 h-12 bg-orange-500  items-center  text-white font-bold py-1.5 px-2 justify-around flex">
            ...
            {!isPlaying && !gameOver && (
                <div className="absolute top-0 left-0 h-screen w-screen bg-opacity-35 flex items-center justify-center bg-black group ">
                    <div className="bg-gradient-to-br from-yellow-400 to-orange-500 p-1 rounded-lg hover:scale-105 transition-all duration-500">
                        <div
                            className="bg-white rounded-md  p-10 text-center  hover:shadow-[inset_0_0px_6px_rgba(0,0,0,1)]  transition duration-200 hover:duration-200 "
                        ...
                        >
                            ...
                            <div
                                className="bg-gradient-to-br to-yellow-400 from-orange-500 p-1 text-white w-52  rounded-md opacity-80 hover:bg-opacity-100 transition duration-200 hover:duration-200 hover:shadow-[0_0px_6px_rgba(0,0,0,1)]" // Corrected hover class
                            >
                                <button
                                    style={{ maxWidth: "400px" }}
                                    onClick={handleGameStart}
                                    className="w-full text-center bg-gray-800 text-white rounded-md px-2 py-1 hover:bg-gradient-to-br hover:to-yellow-400 hover:from-orange-500 transition-all duration-500 font-bold text-2xl"
                                >
                                    Start
                                </button>
                            </div>
            ...
            {gameOver && (
                <div className="absolute top-0 left-0 h-screen w-screen bg-black bg-opacity-70 flex items-center justify-center">
                    <div className="bg-gradient-to-br from-yellow-400 to-orange-500 p-1 rounded-lg">
                        <div
                            className="bg-white rounded-md shadow-lg p-10 text-center"
                            style={{ maxWidth: "400px" }}
                        >
                            ...
                            <button
                                ...
                                className="bg-gradient-to-br from-yellow-400 to-orange-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                            >
                                Restart
                            </button>
                        </div>
